 ...
 * Generated at: 2019-05-12 11:29:35 UTC
...
public final class productTypeManager_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <script>\r\n");
      out.write("        $(function(){\r\n");
      out.write("            $('#paginator').bootstrapPaginator({\r\n");
      ...
      out.write(",//总页数\r\n");
      out.write("                alignment: 'center',//没卵用。本来设置水平位置\r\n");
      out.write("                itemTexts(type,page,current){\r\n");
      ...
      out.write("                   }\r\n");
      out.write("                },\r\n");
      out.write("               pageUrl:function (type,page,current) {//超链接跳转地址\r\n");
      out.write("                   return '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      ...
      out.write("\r\n");
      out.write("        //显示商品信息\r\n");
      out.write("        function showProducyType(id){\r\n");
      out.write("            $.post(\r\n");
      out.write("                '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      ...
      out.write("                       console.log(result.data.name);\r\n");
      ...
      out.write("\r\n");
      out.write("        }\r\n");
      out.write("        function confireModify() {\r\n");
      out.write("                $.post(\r\n");
      out.write("                    '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/backend/productType/update',\r\n");
      out.write("                    {\"id\":$(\"#proTypeNum\").val(),\"name\":$(\"#proTypeName\").val()},\r\n");
      out.write("                    function(result){\r\n");
      out.write("                        if(result.status==1){\r\n");
      out.write("                            alert(result.msg);\r\n");
      out.write("                            location.href='");
      ...
      out.write("            $(\"#ProductDelete\").modal('show');\r\n");
      out.write("            $(\"#deleteproductTyId\").val(id);\r\n");
      out.write("        }\r\n");
      ...
      out.write("                {'id':$('#deleteproductTyId').val()},\r\n");
      out.write("                function (result){\r\n");
      out.write("                  if(result.status==1){\r\n");
      out.write("                      alert(result.msg);\r\n");
      out.write("                      location.href='");
      ...
      out.write("            );\r\n");
      out.write("        }\r\n");
      out.write("        function modifyStstus(id,btn){\r\n");
      out.write("            $.post(\r\n");
      out.write("\r\n");
      out.write("                '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/backend/productType/modifystayus',\r\n");
      out.write("                {'id':id},\r\n");
      out.write("                function(result) {\r\n");
      out.write("                    //$td=$(btn).parent().parent().children().eq(2);\r\n");
      out.write("                    $td = $(btn).parent().prev();\r\n");
      ...
      out.write("                    <button class=\"btn btn-primary addProductType\" data-dismiss=\"modal\" onclick=\"addProductType()\">添加</button>\r\n");
      ...
      out.write("                </div>\r\n");
      out.write("                <div class=\"modal-footer\">\r\n");
      out.write("                    <button class=\"btn btn-warning updateProType\" onclick=\"confireModify()\">修改</button>\r\n");
      out.write("                    <button class=\"btn btn-primary cancel\" data-dismiss=\"modal\">取消</button>\r\n");
      out.write("                </div>\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      ...
      out.write("    <div class=\"modal fade\" tabindex=\"-1\" id=\"ProductDelete\">\r\n");
      out.write("        <!-- 窗口声明 -->\r\n");
      out.write("        <div class=\"modal-dialog modal-lg\">\r\n");
      out.write("            <!-- 内容声明 -->\r\n");
      out.write("            <div class=\"modal-content\">\r\n");
      ...
      out.write("                </div>\r\n");
      out.write("                <div class=\"modal-footer\">\r\n");
      out.write("                    <input type=\"hidden\" id=\"deleteproductTyId\"/>\r\n");
      out.write("                    <button class=\"btn btn-primary addProductType\" onclick=\"deleteProductType()\">删除</button>\r\n");
      out.write("                    <button class=\"btn btn-primary cancel\" data-dismiss=\"modal\">取消</button>\r\n");
      out.write("                </div>\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/productTypeManager.jsp(158,20) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/productTypeManager.jsp(158,20) '${pageInfo.list}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${pageInfo.list}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /WEB-INF/views/productTypeManager.jsp(158,20) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("                                <input type=\"button\" class=\"btn btn-warning btn-sm doProTypeModify\" value=\"修改\" onclick=\"showProducyType(");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${productType.id}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write(")\">\r\n");
          out.write("                                <input type=\"button\" class=\"btn btn-warning btn-sm doProTypeDelete\" value=\"删除\" onclick=\"showConfirm(");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${productType.id}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write(")\">\r\n");
          out.write("                                ");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /WEB-INF/views/productTypeManager.jsp(163,32) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /WEB-INF/views/productTypeManager.jsp(164,32) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /WEB-INF/views/productTypeManager.jsp(169,32) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_c_005fif_005f2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("                                    <input type=\"button\" class=\"btn btn-danger btn-sm doProTypeDisable\" value=\"禁用\" onclick=\"modifyStstus(");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${productType.id}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
        out.write(",this)\">\r\n");
        out.write("                                ");
  ...
  private boolean _jspx_meth_c_005fif_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /WEB-INF/views/productTypeManager.jsp(172,32) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_c_005fif_005f3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("                                    <input type=\"button\" class=\"btn btn-success btn-sm doProTypeDisable\" value=\"启用\" onclick=\"modifyStstus(");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${productType.id}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
        out.write(",this)\">\r\n");
        out.write("                                ");
